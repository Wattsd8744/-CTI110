...
integer5 = int(input("lastly, how much do you predict on dining expenses:"))
print("-----------------travel expenses calculated-----------------")
print(f'{"location:":13} {destination}')
print(f'{"your budget:":16} {integer1}')
print(f'{"gas expenses:" :16} {integer3}')
print(f'{"accomodations:" :16} {integer4}')
print(f'{"dining expenses:" :16} {integer5}')
result = integer1 - integer3 - integer4 - integer5
print(f'{"remaining:" :16} {result}')